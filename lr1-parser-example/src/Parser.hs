...
; S21 ((p,  ")") : input, end) (e :> stk@(_, pos, _)) ->
    gotoExprs1 ((p,  ")") : input, end) (action48 pos e) stk
; S22 ((p,  ")") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExpr ((p,  ")") : input, end) (action51 pos a) stk
; S22 ((p,  ",") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExpr ((p,  ",") : input, end) (action51 pos a) stk
; S23 ((p,  ")") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExpr ((p,  ")") : input, end) (action51 pos a) stk
; S24 ((p,  ")") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExpr ((p,  ")") : input, end) (action50 pos a b) stk
; S25 ((p,  ")") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExpr ((p,  ")") : input, end) (action50 pos a b) stk
; S25 ((p,  ",") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExpr ((p,  ",") : input, end) (action50 pos a b) stk
; S26 ((p,  ")") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExprAdd ((p,  ")") : input, end) (action54 pos a) stk
; S26 ((p,  "+") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExprAdd ((p,  "+") : input, end) (action54 pos a) stk
...
; S30 ((p,  ")") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExprAdd ((p,  ")") : input, end) (action53 pos a b) stk
; S30 ((p,  "+") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExprAdd ((p,  "+") : input, end) (action53 pos a b) stk
...
; S34 ((p,  ")") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExprMult ((p,  ")") : input, end) (action57 pos a) stk
; S34 ((p,  "*") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExprMult ((p,  "*") : input, end) (action57 pos a) stk
; S34 ((p,  "+") : input, end) (a :> stk@(_, pos, _)) ->
    gotoExprMult ((p,  "+") : input, end) (action57 pos a) stk
...
; S42 ((p,  ")") : input, end) (n :> stk@(_, pos, _)) ->
    gotoExprTerm ((p,  ")") : input, end) (action60 pos n) stk
; S42 ((p,  "*") : input, end) (n :> stk@(_, pos, _)) ->
    gotoExprTerm ((p,  "*") : input, end) (action60 pos n) stk
; S42 ((p,  "+") : input, end) (n :> stk@(_, pos, _)) ->
    gotoExprTerm ((p,  "+") : input, end) (action60 pos n) stk
...
; S46 ((p,  ")") : input, end) (n :> stk@(_, pos, _)) ->
    gotoExprTerm ((p,  ")") : input, end) (action61 pos n) stk
; S46 ((p,  "*") : input, end) (n :> stk@(_, pos, _)) ->
    gotoExprTerm ((p,  "*") : input, end) (action61 pos n) stk
; S46 ((p,  "+") : input, end) (n :> stk@(_, pos, _)) ->
    gotoExprTerm ((p,  "+") : input, end) (action61 pos n) stk
...
; S50 ((p,  ")") : input, end) (n :> stk@(_, pos, _)) ->
    gotoConst ((p,  ")") : input, end) (action63 pos n) stk
; S50 ((p,  "*") : input, end) (n :> stk@(_, pos, _)) ->
    gotoConst ((p,  "*") : input, end) (action63 pos n) stk
; S50 ((p,  "+") : input, end) (n :> stk@(_, pos, _)) ->
    gotoConst ((p,  "+") : input, end) (action63 pos n) stk
...
; S54 ((p,  ")") : input, end) (n :> stk@(_, pos, _)) ->
    gotoConst ((p,  ")") : input, end) (action64 pos n) stk
; S54 ((p,  "*") : input, end) (n :> stk@(_, pos, _)) ->
    gotoConst ((p,  "*") : input, end) (action64 pos n) stk
; S54 ((p,  "+") : input, end) (n :> stk@(_, pos, _)) ->
    gotoConst ((p,  "+") : input, end) (action64 pos n) stk
...
; S73 ((p,  ")") : input, end) (es :> _ :? e :? stk@(_, pos, _)) ->
    gotoExprs1 ((p,  ")") : input, end) (action47 pos e es) stk
; S74 ((p,  ")") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExprMult ((p,  ")") : input, end) (action56 pos a b) stk
; S74 ((p,  "*") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExprMult ((p,  "*") : input, end) (action56 pos a b) stk
; S74 ((p,  "+") : input, end) (b :> _ :? a :? stk@(_, pos, _)) ->
    gotoExprMult ((p,  "+") : input, end) (action56 pos a b) stk
...
; S78 ((p,  ")") : input, end) (_ :> e :? _ :? stk@(_, pos, _)) ->
    gotoExprTerm ((p,  ")") : input, end) (action59 pos e) stk
; S78 ((p,  "*") : input, end) (_ :> e :? _ :? stk@(_, pos, _)) ->
    gotoExprTerm ((p,  "*") : input, end) (action59 pos e) stk
; S78 ((p,  "+") : input, end) (_ :> e :? _ :? stk@(_, pos, _)) ->
    gotoExprTerm ((p,  "+") : input, end) (action59 pos e) stk
...
; S142 ((p,  ",") : input, end) (c :> stk@(_, pos, _)) ->
    gotoCond ((p,  ",") : input, end) (action38 pos c) stk
; S142 ((p,  ".") : input, end) (c :> stk@(_, pos, _)) ->
    gotoCond ((p,  ".") : input, end) (action38 pos c) stk
...
; S146 ((p,  ",") : input, end) (e :> stk@(_, pos, _)) ->
    gotoCond ((p,  ",") : input, end) (action40 pos e) stk
; S146 ((p,  ".") : input, end) (e :> stk@(_, pos, _)) ->
    gotoCond ((p,  ".") : input, end) (action40 pos e) stk
...
; S152 ((p,  ",") : input, end) (c :> _ :? stk@(_, pos, _)) ->
    gotoChange ((p,  ",") : input, end) (action29 pos c) stk
; S152 ((p,  ".") : input, end) (c :> _ :? stk@(_, pos, _)) ->
    gotoChange ((p,  ".") : input, end) (action29 pos c) stk
...
; S154 ((p,  ",") : input, end) (c :> _ :? stk@(_, pos, _)) ->
    gotoCond ((p,  ",") : input, end) (action39 pos c) stk
; S154 ((p,  ".") : input, end) (c :> _ :? stk@(_, pos, _)) ->
    gotoCond ((p,  ".") : input, end) (action39 pos c) stk
...
; S156 ((p,  ",") : input, end) (t :> pred :? stk@(_, pos, _)) ->
    gotoCall ((p,  ",") : input, end) (action42 pos pred t) stk
; S156 ((p,  ".") : input, end) (t :> pred :? stk@(_, pos, _)) ->
    gotoCall ((p,  ".") : input, end) (action42 pos pred t) stk
...
; S158 ((p,  ",") : input, end) (_ :> _ :? stk@(_, pos, _)) ->
    gotoTuple ((p,  ",") : input, end) (action44 pos ) stk
; S158 ((p,  ".") : input, end) (_ :> _ :? stk@(_, pos, _)) ->
    gotoTuple ((p,  ".") : input, end) (action44 pos ) stk
...
; S164 ((p,  ",") : input, end) (_ :> es :? _ :? stk@(_, pos, _)) ->
    gotoTuple ((p,  ",") : input, end) (action45 pos es) stk
; S164 ((p,  ".") : input, end) (_ :> es :? _ :? stk@(_, pos, _)) ->
    gotoTuple ((p,  ".") : input, end) (action45 pos es) stk
...
; S173 ((p,  ".") : input, end) (c :> stk@(_, pos, _)) ->
    gotoConds ((p,  ".") : input, end) (action36 pos c) stk
...
; S179 ((p,  ".") : input, end) (cs :> _ :? c :? stk@(_, pos, _)) ->
    gotoConds ((p,  ".") : input, end) (action35 pos c cs) stk

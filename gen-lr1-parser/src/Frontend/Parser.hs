...
data StGrammar xs where
  ...
  StGrammar_27 :: StGrammar (() : () : Text : () : Text : a)
  StGrammar_28 :: StGrammar ((Pos, Symbol) : () : () : Text : () : Text : a)
  StGrammar_29 :: StGrammar (() : (Pos, Symbol) : () : () : Text : () : Text : a)
  StGrammar_30 :: StGrammar (() : () : (Pos, Symbol) : () : () : Text : () : Text : a)
  StGrammar_31 :: StGrammar (Text : () : () : (Pos, Symbol) : () : () : Text : () : Text : a)
  StGrammar_32 :: StGrammar (Text : a)
  StGrammar_33 :: StGrammar (Text : a)
  StGrammar_34 :: StGrammar (() : Text : a)
  StGrammar_35 :: StGrammar (NonEmpty RawClause : () : Text : a)
  StGrammar_36 :: StGrammar (NonEmpty RawStmt : NonEmpty (Pos, NonTerminal) : [Text] : a)
  StGrammar_37 :: StGrammar (() : a)
  StGrammar_38 :: StGrammar (NonEmpty (Pos, NonTerminal) : () : a)
  StGrammar_39 :: StGrammar ((Pos, NonTerminal) : a)
  StGrammar_40 :: StGrammar (() : (Pos, NonTerminal) : a)
  StGrammar_41 :: StGrammar (NonEmpty (Pos, NonTerminal) : () : (Pos, NonTerminal) : a)
  StGrammar_42 :: StGrammar (Text : a)
  StGrammar_43 :: StGrammar (RawGrammar : a)
  StGrammar_44 :: StGrammar (() : a)
  StGrammar_45 :: StGrammar (NonEmpty Text : () : a)
  StGrammar_46 :: StGrammar (Text : a)
  StGrammar_47 :: StGrammar (NonEmpty Text : Text : a)
...
gotoClauseForGrammar stack@(state, pos, _) parsed = case state of
  ...
  StGrammar_34 -> actionForGrammar(StGrammar_11, pos, (parsed :> stack))
  _ -> error ""
...
gotoGrammarForGrammar stack@(state, pos, _) parsed = case state of
  StGrammar_0 -> actionForGrammar(StGrammar_43, pos, (parsed :> stack))
  _ -> error ""
...
gotoLinesForGrammar stack@(state, pos, _) parsed = case state of
  StGrammar_44 -> actionForGrammar(StGrammar_45, pos, (parsed :> stack))
...
gotoNonTerminalsForGrammar stack@(state, pos, _) parsed = case state of
  StGrammar_37 -> actionForGrammar(StGrammar_38, pos, (parsed :> stack))
  StGrammar_40 -> actionForGrammar(StGrammar_41, pos, (parsed :> stack))
  _ -> error ""
...
gotoRefForGrammar stack@(state, pos, _) parsed = case state of
  StGrammar_27 -> actionForGrammar(StGrammar_28, pos, (parsed :> stack))
  _ -> error ""
...
gotoStarterForGrammar stack@(state, pos, _) parsed = case state of
  StGrammar_37 -> actionForGrammar(StGrammar_39, pos, (parsed :> stack))
  StGrammar_40 -> actionForGrammar(StGrammar_39, pos, (parsed :> stack))
  _ -> error ""
...
gotoStmtsForGrammar stack@(state, pos, _) parsed = case state of
  StGrammar_2 -> actionForGrammar(StGrammar_36, pos, (parsed :> stack))
...
gotoSymbolForGrammar stack@(state, pos, _) parsed = case state of
  ...
  StGrammar_34 -> actionForGrammar(StGrammar_14, pos, (parsed :> stack))
  _ -> error ""
...
gotoSymbolsForGrammar stack@(state, pos, _) parsed = case state of
  ...
  StGrammar_34 -> actionForGrammar(StGrammar_23, pos, (parsed :> stack))
  _ -> error ""
...
gotoTerminalForGrammar stack@(state, pos, _) parsed = case state of
  ...
  StGrammar_34 -> actionForGrammar(StGrammar_16, pos, (parsed :> stack))
  _ -> error ""

actionForGrammar :: Stack StGrammar xs -> [Lexeme] -> Pos -> Either (Pos, [String]) (RawGrammar)
actionForGrammar = \cases
  stk@(StGrammar_0, _, _) ((pos, "imports") : input) -> actionForGrammar (StGrammar_44,  pos, () :> stk) input
  ___@(StGrammar_0, _, _) input -> \end -> Left (currentPos input end, ["imports"])
  stk@(StGrammar_1, _, _) ((pos, "start") : input) -> actionForGrammar (StGrammar_37,  pos, () :> stk) input
  ...
  stk@(StGrammar_7, _, _) ((pos, "=") : input) -> actionForGrammar (StGrammar_34,  pos, () :> stk) input
  ...
  stk@(StGrammar_10, _, _) ((pos, StringLiteral n) : input) -> actionForGrammar (StGrammar_22,  pos, n :> stk) input
  stk@(StGrammar_10, _, _) ((pos, "some") : input) -> actionForGrammar (StGrammar_27,  pos, () :> stk) input
  ___@(StGrammar_10, _, _) input -> \end -> Left (currentPos input end, ["<name>", "<string>", "some"])
  ...
  stk@(StGrammar_27, _, _) ((pos, UppercaseName n) : input) -> actionForGrammar (StGrammar_32,  pos, n :> stk) input
  stk@(StGrammar_27, _, _) ((pos, StringLiteral n) : input) -> actionForGrammar (StGrammar_33,  pos, n :> stk) input
  ___@(StGrammar_27, _, _) input -> \end -> Left (currentPos input end, ["<Name>", "<string>"])
  ___@(StGrammar_28, _, single :> (_, _, _ :> (_, _, _ :> (_, _, type_ :> (_, _, _ :> (_, _, entity :> stk@(_, pos, _))))))) input@[] -> gotoSepForGrammar stk (RawSep {pos, entity, type_, single, sep = Nothing}) input
  ___@(StGrammar_28, _, single :> (_, _, _ :> (_, _, _ :> (_, _, type_ :> (_, _, _ :> (_, _, entity :> stk@(_, pos, _))))))) input@((_, UppercaseName _) : _) -> gotoSepForGrammar stk (RawSep {pos, entity, type_, single, sep = Nothing}) input
  stk@(StGrammar_28, _, _) ((pos, "sep") : input) -> actionForGrammar (StGrammar_29,  pos, () :> stk) input
  ___@(StGrammar_28, _, _) input -> \end -> Left (currentPos input end, ["EOF", "<Name>", "sep"])
  stk@(StGrammar_29, _, _) ((pos, "by") : input) -> actionForGrammar (StGrammar_30,  pos, () :> stk) input
  ___@(StGrammar_29, _, _) input -> \end -> Left (currentPos input end, ["by"])
  stk@(StGrammar_30, _, _) ((pos, StringLiteral n) : input) -> actionForGrammar (StGrammar_31,  pos, n :> stk) input
  ___@(StGrammar_30, _, _) input -> \end -> Left (currentPos input end, ["<string>"])
  ___@(StGrammar_31, _, t :> (_, _, _ :> (_, _, _ :> (_, _, single :> (_, _, _ :> (_, _, _ :> (_, _, type_ :> (_, _, _ :> (_, _, entity :> stk@(_, pos, _)))))))))) input@[] -> gotoSepForGrammar stk (RawSep {pos, entity, type_, single, sep = Just t}) input
  ___@(StGrammar_31, _, t :> (_, _, _ :> (_, _, _ :> (_, _, single :> (_, _, _ :> (_, _, _ :> (_, _, type_ :> (_, _, _ :> (_, _, entity :> stk@(_, pos, _)))))))))) input@((_, UppercaseName _) : _) -> gotoSepForGrammar stk (RawSep {pos, entity, type_, single, sep = Just t}) input
  ___@(StGrammar_31, _, _) input -> \end -> Left (currentPos input end, ["EOF", "<Name>"])
  ___@(StGrammar_32, _, nt :> stk@(_, pos, _)) input@[] -> gotoRefForGrammar stk ((pos, NonTerm nt)) input
  ___@(StGrammar_32, _, nt :> stk@(_, pos, _)) input@((_, UppercaseName _) : _) -> gotoRefForGrammar stk ((pos, NonTerm nt)) input
  ___@(StGrammar_32, _, nt :> stk@(_, pos, _)) input@((_, "sep") : _) -> gotoRefForGrammar stk ((pos, NonTerm nt)) input
  ___@(StGrammar_32, _, _) input -> \end -> Left (currentPos input end, ["EOF", "<Name>", "sep"])
  ___@(StGrammar_33, _, t :> stk@(_, pos, _)) input@[] -> gotoRefForGrammar stk ((pos, Term t)) input
  ___@(StGrammar_33, _, t :> stk@(_, pos, _)) input@((_, UppercaseName _) : _) -> gotoRefForGrammar stk ((pos, Term t)) input
  ___@(StGrammar_33, _, t :> stk@(_, pos, _)) input@((_, "sep") : _) -> gotoRefForGrammar stk ((pos, Term t)) input
  ___@(StGrammar_33, _, _) input -> \end -> Left (currentPos input end, ["EOF", "<Name>", "sep"])
  stk@(StGrammar_34, _, _) ((pos, LowercaseName n) : input) -> actionForGrammar (StGrammar_17,  pos, n :> stk) input
  stk@(StGrammar_34, _, _) ((pos, StringLiteral n) : input) -> actionForGrammar (StGrammar_22,  pos, n :> stk) input
  ___@(StGrammar_34, _, _) input -> \end -> Left (currentPos input end, ["<name>", "<string>"])
  ___@(StGrammar_35, _, clauses :> (_, _, _ :> (_, _, entity :> stk@(_, pos, _)))) input@[] -> gotoRuleForGrammar stk (RawRule {pos, entity, type_ = entity, clauses}) input
  ___@(StGrammar_35, _, clauses :> (_, _, _ :> (_, _, entity :> stk@(_, pos, _)))) input@((_, UppercaseName _) : _) -> gotoRuleForGrammar stk (RawRule {pos, entity, type_ = entity, clauses}) input
  ___@(StGrammar_35, _, _) input -> \end -> Left (currentPos input end, ["EOF", "<Name>"])
  ___@(StGrammar_36, _, rules :> (_, _, targets :> (_, _, adds :> stk@(_, pos, _)))) input@[] -> gotoGrammarForGrammar stk (RawGrammar {imports = adds, targets, rules}) input
  ___@(StGrammar_36, _, _) input -> \end -> Left (currentPos input end, ["EOF"])
  stk@(StGrammar_37, _, _) ((pos, UppercaseName n) : input) -> actionForGrammar (StGrammar_42,  pos, n :> stk) input
  ___@(StGrammar_37, _, _) input -> \end -> Left (currentPos input end, ["<Name>"])
  ___@(StGrammar_38, _, es :> (_, _, _ :> stk@(_, pos, _))) input@((_, UppercaseName _) : _) -> gotoStartersForGrammar stk (es) input
  ___@(StGrammar_38, _, _) input -> \end -> Left (currentPos input end, ["<Name>"])
  stk@(StGrammar_39, _, _) ((pos, ",") : input) -> actionForGrammar (StGrammar_40,  pos, () :> stk) input
  ___@(StGrammar_39, _, x :> stk@(_, pos, _)) input@((_, UppercaseName _) : _) -> gotoNonTerminalsForGrammar stk ([x]) input
  ___@(StGrammar_39, _, _) input -> \end -> Left (currentPos input end, [",", "<Name>"])
  stk@(StGrammar_40, _, _) ((pos, UppercaseName n) : input) -> actionForGrammar (StGrammar_42,  pos, n :> stk) input
  ___@(StGrammar_40, _, _) input -> \end -> Left (currentPos input end, ["<Name>"])
  ___@(StGrammar_41, _, xs :> (_, _, _ :> (_, _, x :> stk@(_, pos, _)))) input@((_, UppercaseName _) : _) -> gotoNonTerminalsForGrammar stk (NonEmpty.cons x xs) input
  ___@(StGrammar_41, _, _) input -> \end -> Left (currentPos input end, ["<Name>"])
  ___@(StGrammar_42, _, nt :> stk@(_, pos, _)) input@((_, ",") : _) -> gotoStarterForGrammar stk ((pos, nt)) input
  ___@(StGrammar_42, _, nt :> stk@(_, pos, _)) input@((_, UppercaseName _) : _) -> gotoStarterForGrammar stk ((pos, nt)) input
  ___@(StGrammar_42, _, _) input -> \end -> Left (currentPos input end, [",", "<Name>"])
  ___@(StGrammar_43, _, e :> _) [] -> \_ -> Right e
  ___@(StGrammar_43, _, _) input -> \end -> Left (currentPos input end, ["EOF"])
  stk@(StGrammar_44, _, _) ((pos, StringLiteral n) : input) -> actionForGrammar (StGrammar_46,  pos, n :> stk) input
  ___@(StGrammar_44, _, _ :> stk@(_, pos, _)) input@((_, "start") : _) -> gotoAdditionsForGrammar stk ([]) input
  ___@(StGrammar_44, _, _) input -> \end -> Left (currentPos input end, ["<string>", "start"])
  ___@(StGrammar_45, _, ls :> (_, _, _ :> stk@(_, pos, _))) input@((_, "start") : _) -> gotoAdditionsForGrammar stk (NonEmpty.toList ls) input
  ___@(StGrammar_45, _, _) input -> \end -> Left (currentPos input end, ["start"])
  stk@(StGrammar_46, _, _) ((pos, StringLiteral n) : input) -> actionForGrammar (StGrammar_46,  pos, n :> stk) input
  ___@(StGrammar_46, _, x :> stk@(_, pos, _)) input@((_, "start") : _) -> gotoLinesForGrammar stk ([x]) input
  ___@(StGrammar_46, _, _) input -> \end -> Left (currentPos input end, ["<string>", "start"])
  ___@(StGrammar_47, _, xs :> (_, _, x :> stk@(_, pos, _))) input@((_, "start") : _) -> gotoLinesForGrammar stk (NonEmpty.cons x xs) input
